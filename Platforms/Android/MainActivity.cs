...
namespace DoubleDashScore
{
    ...
    public class MainActivity : MauiAppCompatActivity
    {
        ...
        // OnCreate köras orörd. Statusbar-färgen styrs nu via colorPrimary i
        // Platforms/Android/Resources/values/colors.xml (= #1F1F1F), vilket Material:s
        // default-tema mappar till android:statusBarColor via colorPrimaryVariant.
